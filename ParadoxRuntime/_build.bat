...
if not defined MSBUILD (
  ...
  echo   msbuild MysticParadox.sln /p:Configuration=Release /p:Platform=x64
  exit /b 1
)
"%MSBUILD%" MysticParadox.sln /p:Configuration=Release /p:Platform=x64 /nologo /verbosity:minimal
